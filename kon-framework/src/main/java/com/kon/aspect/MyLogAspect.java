...
public class MyLogAspect {
    ...
    @Pointcut("@annotation(com.kon.annotation.MySystemLog)")
    ...
    //上面的xxprintLog方法执行之前会去调用下面这个handleBefore方法
    ...
    //上面的xxprintLog方法执行之后会去调用下面这个handleAfter方法
